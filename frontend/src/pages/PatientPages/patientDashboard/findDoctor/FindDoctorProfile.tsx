    ...
    <DashboardSection>
      <div className="flex justify-between my-4">
        ...
        <div className="flex gap-2">
          <Button title="Save Doctor Profile" className="w-fit" />
          <Button title="Subscribe" className="w-fit" />
          <Button title="Report Doctor" className="w-fit" />
        </div>
      </div>
        ...
        <ContentSection className="mt-0 mb-1.5">
          <div className="flex justify-between gap-2 my-2">
            ...
            <div className="w-1/5 flex flex-col gap-2">
              <Button title="Book Clinic Visit" />
              <Button title="Video Call" />
              <Button title="View Timings" />
            </div>
          </div>
