const DropdownField = ({
  ...
  return (
    <div className="my-6">
      <div
        className="text-primary w-full cursor-pointer outline-none font-medium rounded-lg border border-primary relative text-sm text-center flex justify-between items-center"
